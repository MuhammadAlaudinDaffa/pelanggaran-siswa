        ...
        <div class="col-12">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">Dashboard Kesiswaan - Manajemen Pelanggaran dan Prestasi Siswa</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-4 col-md-6 col-12 mb-4">
            <div class="card h-100 d-flex flex-column">
                <div class="card-body text-center flex-grow-1">
                    ...
                    <h5 class="card-title mb-1">Overview Siswa</h5>
                    <p class="text-muted mb-0">Data Siswa</p>
                </div>
                <div class="card-footer bg-transparent border-0 pt-0">
                    <a href="{{ route('kesiswaan.kesiswaan.siswa_overview.index') }}" class="btn btn-primary btn-sm w-100">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-xl-4 col-md-6 col-12 mb-4">
            <div class="card h-100 d-flex flex-column">
                ...
                <div class="card-footer bg-transparent border-0 pt-0">
                    <a href="{{ route('kesiswaan.kesiswaan.sanksi.index') }}" class="btn btn-warning btn-sm w-100">
                        <i class="ti ti-eye me-1"></i> Kelola Sanksi
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6 col-12 mb-4">
            <div class="card h-100 d-flex flex-column">
                ...
                <div class="card-footer bg-transparent border-0 pt-0">
                    <a href="{{ route('kesiswaan.kesiswaan.pelaksanaan_sanksi.index') }}" class="btn btn-info btn-sm w-100">
                        <i class="ti ti-eye me-1"></i> Kelola Pelaksanaan
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6 col-12 mb-4">
            <div class="card h-100 d-flex flex-column">
                ...
                <div class="card-footer bg-transparent border-0 pt-0">
                    <a href="{{ route('kesiswaan.kesiswaan.monitoring_pelanggaran.index') }}" class="btn btn-secondary btn-sm w-100">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-md-6 col-12 mb-4">
                <div class="card h-100 d-flex flex-column">
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('kesiswaan.guru.info_kelas.index') }}" class="btn btn-primary btn-sm w-100">
