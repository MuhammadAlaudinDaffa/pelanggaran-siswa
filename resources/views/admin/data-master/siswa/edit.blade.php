        ...
        <div class="col-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.data-master.siswa.update', $siswa->siswa_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id" required>
                                        <option value="">Pilih UserID</option>
                                        @foreach($users as $item)
                                            <option value="{{ $item->user_id }}" {{ old('user_id', $siswa->user_id) == $item->user_id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" 
                                           id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $siswa->tanggal_lahir) }}">
                                    @error('tanggal_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-2">
                                        @if($siswa->foto)
                                            <img id="preview-foto" src="{{ asset('storage/' . $siswa->foto) }}" alt="Foto Siswa" 
