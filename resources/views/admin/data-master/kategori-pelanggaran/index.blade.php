        ...
        <div class="col-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Daftar Kategori Pelanggaran</h5>
                    <div class="d-flex gap-2 mb-3">
                        <a href="{{ route('admin.data-master.kategori-pelanggaran.create') }}" class="btn btn-secondary">
                            <i class="ti ti-plus"></i>
                            Tambah Kategori
                        </a>
                        <a href="{{ route('admin.data-master.jenis-pelanggaran.index') }}" class="btn btn-outline-info">
                            <i class="ti ti-arrow-left"></i>
                            Kembali ke Pelanggaran
                        </a>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <form method="GET" class="d-flex gap-2">
                                ...
                                @if(request('search'))
                                    <a href="{{ route('admin.data-master.kategori-pelanggaran.index') }}" class="btn btn-outline-secondary">Reset</a>
                                @endif
                            </form>
                        </div>
                                ...
                                @else
                                    @foreach ($kategori as $item)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <a class="btn btn-outline-info btn-sm" href="{{ route('admin.data-master.kategori-pelanggaran.show', $item->kategori_pelanggaran_id) }}">
                                                    <i class="ti ti-eye"></i>
                                                </a>
                                                <a class="btn btn-outline-warning btn-sm" href="{{ route('admin.data-master.kategori-pelanggaran.edit', $item->kategori_pelanggaran_id) }}">
                                                    <i class="ti ti-edit"></i>
                                                </a>
                                                <form action="{{ route('admin.data-master.kategori-pelanggaran.destroy', $item->kategori_pelanggaran_id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
